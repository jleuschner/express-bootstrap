...
--
-- Tabellenstruktur für Tabelle `dokusys_topics`
--
DROP TABLE IF EXISTS `dokusys_topics`;
CREATE TABLE IF NOT EXISTS `dokusys_topics` (
...
--
-- Daten für Tabelle `dokusys_topics`
--
...
--
DROP TABLE IF EXISTS `dokusys_links`;
CREATE TABLE IF NOT EXISTS `dokusys_links` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
DROP TABLE IF EXISTS `dokusys_uploads`;
CREATE TABLE IF NOT EXISTS `dokusys_uploads` (
  `id` int(10) unsigned NOT NULL auto_increment,
